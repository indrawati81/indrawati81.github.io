<html>
<head>
    <title>Toko Online SerbaBebas</title>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +62858 2819 5860</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> Serbabebas0410@gmail.com</a></li>
							</ul>
						</div>
					</div>
				</div>
